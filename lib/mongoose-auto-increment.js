 ...
 * Custome node module for mongoose, instead of overwriting the pre-save middleware,
 * just using it in pre-save middleware
 */
...
exports.makeSettings = function(options) {
...
exports.plugin = function (schema, settings) {
...
// Rewrite here @YanshuoH
exports.proceedIncrementField = function(doc, settings, callback) {
    ...
    IdentityCounter.findOne(
        { _id: settings.model, field: settings.field },
        function (err, counter) {
            if (!counter) {
            ...
            if (ready) {
                ...
                IdentityCounter.findOneAndUpdate(
                    ...
                    function (err, updatedIdentityCounter) {
                        ...
                        return callback(null, 'keep it cool');
                    }
                );
            }
